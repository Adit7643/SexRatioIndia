    ...
    typography: {
        h5: {
            ...
            "@media (max-width:600px)": {
                fontSize: "1.25rem", // Responsive font size for smaller screens
            },
        },
        body1: {
            fontFamily: "QuickSand",
            ...
            "@media (max-width:600px)": {
                fontSize: "0.875rem", // Responsive font size for smaller screens
            },
        },
    },
    components: {
        MuiListItemText: {
            styleOverrides: {
                primary: {
                    fontFamily: "QuickSand",
                    fontWeight: "500",
                    fontSize: "1rem", // Default font size for primary text
                    "@media (max-width:600px)": {
                        fontSize: "0.875rem", // Responsive font size for smaller screens
                    },
                },
                secondary: {
                    fontFamily: "QuickSand",
                    fontWeight: "500",
                    fontSize: "1rem", // Default font size for secondary text
                    "@media (max-width:600px)": {
                        fontSize: "0.875rem", // Responsive font size for smaller screens
                    },
                },
